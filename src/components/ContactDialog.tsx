            ...
            <div className="p-4">
              {submitted ? (
                ...
                >
                  ...
                  >
                    <h4 className={`font-['Poppins:SemiBold',sans-serif] text-[18px] ${
                  ...
                  <motion.button
                    ...
                    className={`mt-4 px-6 py-2.5 rounded-lg font-['Poppins:SemiBold',sans-serif] text-[13px] transition-all ${
                      theme === 'dark'
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  {/* Your email */}
                  <div>
                    <label className={`mb-1.5 block font-['Poppins:SemiBold',sans-serif] text-[12px] ${
                    ...
                    <input
                      ...
                      required
                      className={`w-full h-[48px] px-4 font-['Poppins:Regular',sans-serif] text-[14px] border transition-colors ${
                        theme === 'dark'
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className={`w-full h-[44px] px-3.5 font-['Poppins:Regular',sans-serif] text-[13.5px] border transition-colors ${
                        theme === 'dark'
                          ? 'bg-white/4 border-white/12 text-white placeholder:text-gray-500 focus:border-white/25 focus:outline-none'
                          : 'bg-gray-50 border-gray-200 text-gray-900 placeholder:text-gray-500 focus:border-gray-400 focus:outline-none'
                      }`}
                    ...
                    />
                    <p className={`mt-1 text-right font-['Poppins:Regular',sans-serif] text-[11px] transition-colors ${
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={4}
                      className={`w-full px-3 py-2 font-['Poppins:Regular',sans-serif] text-[14px] border resize-none transition-colors ${
                        theme === 'dark'
                          ? 'bg-white/4 border-white/12 text-white placeholder:text-gray-500 focus:border-white/25 focus:outline-none'
                          : 'bg-gray-50 border-gray-200 text-gray-900 placeholder:text-gray-500 focus:border-gray-400 focus:outline-none'
                      }`}
                  ...
                  <div className="flex gap-3 pt-2">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      onClick={handleClear}
                      className={`flex-1 h-[48px] font-['Poppins:SemiBold',sans-serif] text-[14px] border transition-all duration-200 backdrop-blur-md flex items-center justify-center ${
                        theme === 'dark'
                    ...
                    <motion.button
                      ...
                      className={`flex-[2] h-[48px] font-['Poppins:SemiBold',sans-serif] text-[15px] transition-all duration-200 shadow-lg flex items-center justify-center relative overflow-hidden ${
